  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="container-fluid">
        <table id="managestudentsTable" class="w-100 table table-bordered table-hover table-striped dt-responsive nowrap">
          <thead>
            <tr>
              <th>Profile</th>
              <th>Student Name</th>
          ...
          <tbody>
            <tr>
              <td>
                <img src="assets/img/profile-img.jpg" alt="Profile" class="tableAvator">
              </td>
              <td>R1C2</td>
              <td>R1C3</td>
              <td>R1C3</td>
